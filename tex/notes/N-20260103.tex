...
For this chapter, the elementary material should be read as a study of what remains invariant when coordinates change. The earlier sections (`Determinant expansion and cofactors`, `Recursive determinants`, `Circulant-style determinant`, `Cancellation through orthogonal matrices`) compute with arrays, bases, pivots, determinants, or eigenvectors; the deeper object is a linear map together with the spaces it acts on. A matrix is a representation of that map after bases have been chosen. This is why formulas such as
\[
...
\section{Elementary-to-advanced bridge: rank factorization and normal forms}
...
\section{Elementary-to-advanced bridge: idempotents as projections}
...
\section{Elementary-to-advanced bridge: spectral asymptotics of matrix powers}
...
\section{Elementary-to-advanced bridge: null spaces and orthogonal complements}
...
\section{Second-pass deepening: matrix powers, projection components, and stable limits}
...
\section{Second-pass deepening: row space, column space, and rank factorization}
...
\section{Second-pass deepening: positivity through Gram forms}
