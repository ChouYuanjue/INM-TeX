...
The common theme of this chapter is that an elementary limiting or computational rule becomes powerful only after one specifies the space in which the limiting process takes place. The earlier sections (`Why two theories of integration exist`, `Riemann sums`, `Darboux upper and lower sums`, `A simple integrable discontinuity`, `Dirichlet's function`) may look like separate techniques, but they all ask the same question: which operations are stable under approximation? A derivative is stable first-order approximation,
\[
  f(a+h)=f(a)+L(h)+o(|h|),
\]
...
\section{Elementary-to-advanced bridge: Riemann sums and measure spaces}
...
\section{Elementary-to-advanced bridge: convergence theorems}
...
\section{Elementary-to-advanced bridge: Lp spaces and duality}
