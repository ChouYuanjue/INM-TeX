...
\begin{remark}
The original note explicitly points out that the indexing collection \(I\) need not be finite or countable.  This is a useful mental shift: the notation \(\{A_i\}_{i\in I}\) is not just a long list.  It may be a genuinely infinite family.
\end{remark}
...
\section{What remains from this note}
