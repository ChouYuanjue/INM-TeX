...
The number-theoretic content of this chapter is best understood as arithmetic seen through algebraic structure. The earlier sections (`Congruence`, `Basic properties`, `Residue classes`, `Complete and reduced residue systems`, `Example: last digit`) compute divisibility, congruences, residues, prime factorizations, or finite-field examples. The deeper language is ideals, quotient rings, unit groups, valuations, and field extensions.
...
\section{Elementary-to-advanced bridge: residue systems as groups of units}
...
\section{Elementary-to-advanced bridge: CRT decomposition of unit groups}
...
\section{Elementary-to-advanced bridge: primitive roots and characters}
...
\section{Returning to residue-system exercises}
...
\section{Second-pass deepening: primitive roots as logarithms in finite groups}
...
\section{Second-pass deepening: characters as Fourier analysis on unit groups}
