...
The higher-level content of this chapter is the passage from pointwise description to invariant structure. The earlier sections (`Good triangles`, `Why vertices must lie on the convex hull`, `Cyclic arc encoding`, `The geometric idea behind the proof`, `Euler formula for convex polyhedra`) introduce objects that may be drawn, listed, glued, or computed, but the advanced question is what remains unchanged under the allowed maps. In topology the allowed maps are continuous maps; in category theory they are morphisms preserving the relevant structure; in homology they induce maps between algebraic invariants.
...
\section{Elementary-to-advanced bridge: Euler characteristic}
...
\section{Elementary-to-advanced bridge: homology interpretation of Euler characteristic}
...
\section{Elementary-to-advanced bridge: degree theory}
...
\section{Elementary-to-advanced bridge: quotient spaces and identifications}
...
\section{Second-pass deepening: Euler characteristic as alternating rank}
...
\section{Second-pass deepening: degree and fixed-point consequences}
