...
% substantial-expansion-20260704
...
\[
\begin{array}{c|c}
\text{equation} & \text{curve}\\
\text{factorization} & \text{decomposition}\\
\text{coordinate ring} & \text{functions}\\
\text{vanishing derivatives} & \text{singularity}\\
\text{homogenization} & \text{points at infinity}
\end{array}
\]
