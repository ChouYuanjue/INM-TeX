...
For this chapter, the elementary material should be read as a study of what remains invariant when coordinates change. The earlier sections (`Tensor products and bases`, `Bilinearity`, `Metric, dot product, and components`, `Reciprocal basis`, `Covariant and contravariant components`) compute with arrays, bases, pivots, determinants, or eigenvectors; the deeper object is a linear map together with the spaces it acts on. A matrix is a representation of that map after bases have been chosen. This is why formulas such as
\[
...
\section{Elementary-to-advanced bridge: dual spaces and reciprocal bases}
...
\section{Elementary-to-advanced bridge: musical isomorphisms}
...
\section{Elementary-to-advanced bridge: frames and moving coordinates}
...
\section{Elementary-to-advanced bridge: continuum mechanics notation}
...
\section{Second-pass deepening: metric tensors and Gram matrices}
...
\section{Second-pass deepening: covariant and contravariant components}
...
\section{Second-pass deepening: why tensor products linearize bilinear data}
