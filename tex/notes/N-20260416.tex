...
First-kind integrals integrate scalar densities against geometric measure.  Second-kind integrals integrate oriented effects: work along curves and flux through surfaces.  The formulas with \(\norm{r'}\), \(r_u\times r_v\), and \(F\cdot n\) are all ways of translating geometric measurement back to parameters.
