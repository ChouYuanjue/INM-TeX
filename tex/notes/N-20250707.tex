\notechapter{N-20250707}{Nikonov's Paper at One Crossing: Region Probes and Partial Tribrackets}

\section{Reading only one small part of a long paper}

Nikonov's paper is long, so the most efficient entry point is the part where regions of diagrams become topological objects and then algebraic operations.  The chapter follows one small path through the paper:
\[
\begin{array}{c}
...
\section{Where this sits inside Nikonov's paper}
...
The construction compresses into one sentence:
\[
...
\]
This local picture already explains the central mechanism.  The rest of the paper builds a much larger machine, but this one crossing explains why the machine is interesting.
