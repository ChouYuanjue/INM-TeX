...
\[
  \text{a knot is a topological object, but we calculate using diagrams.}
\]
...
\section{Invariants, coinvariants, and why labels are not always numbers}
...
\section{What this note is not trying to do}
