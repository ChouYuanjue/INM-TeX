...
For this chapter, the elementary material should be read as a study of what remains invariant when coordinates change. The earlier sections (`Spatial vectors`, `Coordinate formulas`, `Cross product`, `From products to universal properties`, `Categories and groupoids`) compute with arrays, bases, pivots, determinants, or eigenvectors; the deeper object is a linear map together with the spaces it acts on. A matrix is a representation of that map after bases have been chosen. This is why formulas such as
\[
...
\section{Elementary-to-advanced bridge: cross product as Hodge dual of wedge product}
...
\section{Elementary-to-advanced bridge: scalar triple product as volume form}
...
\section{Elementary-to-advanced bridge: Lie algebra of rotations}
...
\section{Elementary-to-advanced bridge: categorical product versus vector product}
...
\section{Second-pass deepening: why the cross product is exceptional}
...
\section{Second-pass deepening: angular velocity and infinitesimal rotations}
...
\section{Second-pass deepening: universal property versus geometric product}
