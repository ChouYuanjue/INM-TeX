...
\begin{tikzpicture}[scale=0.95,>=stealth]
  \node[draw,rounded corners,align=center,minimum width=3.4cm,minimum height=0.9cm] at (0,0) (A) {Diophantine\ inequalities};
  \node[draw,rounded corners,align=center,minimum width=3.4cm,minimum height=0.9cm] at (0,-1.45) (B) {elliptic curve\ bad reduction};
  \node[draw,rounded corners,align=center,minimum width=3.4cm,minimum height=0.9cm] at (0,-2.9) (C) {idele \(q_E\)\ and \(\deg q_E\)};
  \node[draw,rounded corners,align=center,minimum width=3.4cm,minimum height=0.9cm] at (5.0,-2.9) (D) {arithmetic\ fundamental groups};
  \node[draw,rounded corners,align=center,minimum width=3.4cm,minimum height=0.9cm] at (5.0,-1.45) (E) {mono-anabelian\ reconstruction};
  \node[draw,rounded corners,align=center,minimum width=3.4cm,minimum height=0.9cm] at (5.0,0) (F) {theta/log\ deformation};
  \node[draw,rounded corners,align=center,minimum width=3.4cm,minimum height=0.9cm] at (2.5,1.35) (G) {log-volume\ bound};
  \draw[->] (A) -- (B);
  \draw[->] (B) -- (C);
  \draw[->] (C) -- (D);
  \draw[->] (D) -- (E);
...
\section{What this first note establishes}
