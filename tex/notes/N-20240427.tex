...
\section{Exterior derivative: the one derivative behind several operators}
...
\[
\begin{array}{c}
  \text{forms measure; pullbacks transport;}\\
  d\text{ differentiates;}\\
  \text{Stokes moves to the boundary.}
\end{array}
\]
