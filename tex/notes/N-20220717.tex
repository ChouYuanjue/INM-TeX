...
\section{Recurrences as iteration of maps}
...
\section{First-order linear recurrences}

A recurrence
\[
  a_{n+1}=ra_n+b
\]
has a fixed point \(a_*=b/(1-r)\) when \(r\ne1\).  Subtracting the fixed point gives
\[
  a_{n+1}-a_*=r(a_n-a_*).
\]
This turns an affine recurrence into a geometric progression.

\section{Groups behind repeated operations}
...
\section{Sequences as orbits of operations}
