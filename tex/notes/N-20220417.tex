...
The number-theoretic content of this chapter is best understood as arithmetic seen through algebraic structure. The earlier sections (`Proof strategies`, `Cyclic and symmetric sums`, `AM--GM`, `Muirhead's inequality`, `Power means`) compute divisibility, congruences, residues, prime factorizations, or finite-field examples. The deeper language is ideals, quotient rings, unit groups, valuations, and field extensions.
...
\section{Pedagogical repair: inequality methods as choice of language}
...
\section{Elementary-to-advanced bridge: convex functions behind Jensen and Karamata}
...
\section{Elementary-to-advanced bridge: Schur convexity}
...
\section{Elementary-to-advanced bridge: entropy and the log-sum inequality}
