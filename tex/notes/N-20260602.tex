...
\[
\begin{array}{c|c}
LU & \text{general square systems}\\
PA=LU & \text{pivoted stability}\\
A=LL^H & \text{positive definite systems}\\
A=FG & \text{rank structure}\\
A=U\Sigma V^H & \text{singular directions}
\end{array}
\]
