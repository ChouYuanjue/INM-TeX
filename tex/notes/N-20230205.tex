...
\section{Vector triple product as projection identity}
The identity
\[
...
\section{Levi-Civita contraction}
Using \(\varepsilon_{ijk}\), the identity follows from
\[
\varepsilon_{i j k}\varepsilon_{k\ell m}=\delta_{i\ell}\delta_{jm}-\delta_{im}\delta_{j\ell}.
\]
This is tensor contraction: two antisymmetric symbols collapse into Kronecker deltas.
\section{Coordinate-free meaning}
...
\section{Vector identities through tensors and orientation}
