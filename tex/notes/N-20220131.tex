...
This note began as a translation and reading note on Tom Leinster's article \emph{Rethinking Set Theory}.  The article won the Chauvenet Prize, and the reason is easy to feel while reading it: it is not trying to make set theory more technical, but to ask why the set theory used by working mathematicians feels so different from the official ZFC story.
...
\section{What I take from the article}
