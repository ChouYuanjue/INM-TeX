...
At a bad split multiplicative valuation \(v\), one has a Tate parameter \(q_v\), and the arithmetic-deformation viewpoint takes seriously transformations of the shape
\[
...
\section{What the theta-link comparison adds}
