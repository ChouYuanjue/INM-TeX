...
\hypersetup{
	...
	pdfkeywords={INM, mathematics, notes},
	pdfsubject={Informal Notes on Mathematics},
	colorlinks,
	hypertexnames=false,
}
...
\rehead{\footnotesize \textbf{\sffamily INM}, by \emph{Runnel Zhang} (\inmversion)}
...
% Avoid theorem-like headings stranded at the bottom of a page.
% This prevents visually empty Example/Definition boxes whose body starts on the next page.
\newcommand{\inmtheoremneedspace}{\Needspace{10\baselineskip}}
\BeforeBeginEnvironment{example}{\inmtheoremneedspace}
\BeforeBeginEnvironment{theorem}{\inmtheoremneedspace}
\BeforeBeginEnvironment{lemma}{\inmtheoremneedspace}
\BeforeBeginEnvironment{proposition}{\inmtheoremneedspace}
\BeforeBeginEnvironment{corollary}{\inmtheoremneedspace}
\BeforeBeginEnvironment{definition}{\inmtheoremneedspace}
\BeforeBeginEnvironment{remark}{\Needspace{7\baselineskip}}
...
\RedeclareSectionCommand[tocpagenumberwidth=3.2em,tocnumwidth=4.2em]{part}
\RedeclareSectionCommand[tocpagenumberwidth=3.2em,tocnumwidth=4.2em]{chapter}
\RedeclareSectionCommand[tocpagenumberwidth=3.4em,tocnumwidth=3.4em]{section}
...
\usepackage[tight,nohints]{minitoc}
